...
public class Tests
{
    ...
    public static void ClassInitialize(TestContext context)
    {
        if (context != null)
        {
            // Avoid accessing per-test properties (like TestName) here.
            // Log a class-level, allowed property instead.
            Debug.WriteLine($"ClassInitialize: TestRunDirectory = {context.TestRunDirectory}");
        }
    }
